...
class VersionBitsWarningTest(bitcoinRTestFramework):
    ...
    def run_test(self):
        ...
        # Stop-start the node. This is required because bitcoinrd will only warn once about unknown versions or unknown rules activating.
        self.restart_node(0)
