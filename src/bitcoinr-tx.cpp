...
static void SetupbitcoinRTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitcoinr-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitcoinr-tx [options] <hex-tx> [commands]  Update hex-encoded bitcoinr transaction\n" +
            "or:     bitcoinr-tx [options] -create [commands]   Create hex-encoded bitcoinr transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinr transaction
