...
#ifndef BITCOINR_KEYSTORE_H
#define BITCOINR_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/bitcoinr/bips/blob/master/bip-0013.mediawiki
