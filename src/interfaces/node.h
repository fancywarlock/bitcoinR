...
#ifndef BITCOINR_INTERFACES_NODE_H
#define BITCOINR_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoinr node (bitcoinrd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITCOINR_INTERFACES_NODE_H
