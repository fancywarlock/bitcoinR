...
This document provides guidelines for internationalization of the bitcoinR Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinr_en.ts` remains unchanged.
