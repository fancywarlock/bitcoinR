...
class WalletTest(bitcoinRTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 XBR from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 XBR with subtract fee from amount
        ...
        # Sendmany 10 XBR with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/bitcoinr/bitcoinr/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
