...
# TestP2PConn: A peer we use to send messages to bitcoinrd, and store responses.
...
class CompactBlocksTest(bitcoinRTestFramework):
    ...
    # This test actually causes bitcoinrd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bitcoinrd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcoinrd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcoinrd will not send blocktxn responses for blocks whose height is
