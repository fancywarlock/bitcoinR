...
#ifndef BITCOINR_QT_BITCOINRUNITS_H
#define BITCOINR_QT_BITCOINRUNITS_H
...
/** bitcoinR unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class bitcoinRUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit bitcoinRUnits(QObject *parent);

    /** bitcoinR units.
      @note Source: https://en.bitcoinr.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        XBR,
...
typedef bitcoinRUnits::Unit bitcoinRUnit;

#endif // BITCOINR_QT_BITCOINRUNITS_H
