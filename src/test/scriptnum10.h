...
#ifndef BITCOINR_TEST_SCRIPTNUM10_H
#define BITCOINR_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from bitcoinR Core 0.10.0, for cross-comparison.
 */
public:
