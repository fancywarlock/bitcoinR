    ...
    mapper(0)
{
    ...
    ui->bitcoinrAtStartup->setToolTip(ui->bitcoinrAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bitcoinrAtStartup->setText(ui->bitcoinrAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openbitcoinRConfButton->setToolTip(ui->openbitcoinRConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new bitcoinRUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoinrAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openbitcoinRConfButton_clicked()
{
