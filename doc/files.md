...
* bitcoinr.conf: contains configuration settings for bitcoinrd or bitcoinr-qt
* bitcoinrd.pid: stores the process id of bitcoinrd while running
...
* debug.log: contains debug information and general logging generated by bitcoinrd or bitcoinr-qt
