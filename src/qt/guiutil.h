...
#ifndef BITCOINR_QT_GUIUTIL_H
#define BITCOINR_QT_GUIUTIL_H
...
/** Utility functions used by the bitcoinR Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bitcoinr:" URI into recipient object, return true on successful parsing
