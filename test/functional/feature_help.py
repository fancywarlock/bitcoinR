...
"""Verify that starting bitcoinr with -h works as expected."""

from test_framework.test_framework import bitcoinRTestFramework
from test_framework.util import assert_equal

class HelpTest(bitcoinRTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinr with -h for help text")
        ...
        self.log.info("Start bitcoinr with -version for version information")
        ...
        self.log.info("Start bitcoinrd with -fakearg to make sure it does not start")
