...
#ifndef BITCOINR_WALLET_WALLET_H
#define BITCOINR_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinr node, and set to 0 for transactions that were created
...
#endif // BITCOINR_WALLET_WALLET_H
