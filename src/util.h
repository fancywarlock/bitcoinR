 ...
 */
#ifndef BITCOINR_UTIL_H
#define BITCOINR_UTIL_H
...
extern const char * const BITCOINR_CONF_FILENAME;
extern const char * const BITCOINR_PID_FILENAME;
...
{
    std::string s = strprintf("bitcoinr-%s", name);
