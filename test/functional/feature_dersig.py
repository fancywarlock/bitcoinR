...
class BIP66Test(bitcoinRTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bitcoinrd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bitcoinrd produces more specific reject
            # reasons.
